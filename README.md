...
3. run the fig4/prediction_notebooks/CAR_T_experiment_rev.ipynb, for pre revision runs CAR_T_experiment.ipynb
   1. overview:
...
4. run the visualization notebook fig4/prediction_notebooks/CAR_T_vis.ipynb, for pre revision plots CAR_T_vis.ipynb
